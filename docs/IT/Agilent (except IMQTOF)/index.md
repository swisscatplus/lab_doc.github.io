...
The API to send commands to instruments are described in the repository : <span class="fs-2">[API Agilent](https://github.com/swisscatplus/agilentapi){: .btn .btn-purple }</span>
...
We export the results in ASM format when ever possible: <span class="fs-2">[ASM Modeling](https://www.allotrope.org/introduction-to-allotrope-simple-model){: .btn .btn-purple }</span>
