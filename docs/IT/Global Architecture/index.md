...
The documents are here : <span class="fs-2">[Nextcloud/SwissCat-share/1_Projects/P9 - HCI](https://swisscatsrv1.epfl.ch/index.php/apps/files/files/101533?dir=/SwissCat-share/1_Projects/P9%20-%20HCI){: .btn .btn-green }</span>
...
The scheduler is developed in Swiss CAT+ with the help of Coteries and is available here: <span class="fs-2">[Scheduler](https://github.com/swisscatplus/scheduler){: .btn .btn-blue }</span>
